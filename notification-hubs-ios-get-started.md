<properties
	pageTitle="Get started with Azure Notification Hubs for iOS apps | Winodws Azure"
...
[AZURE.INCLUDE [Notification Hubs Enable Apple Push Notifications](../includes/notification-hubs-enable-apple-push-notifications)]
...
[Use Notification Hubs to push notifications to users]: notification-hubs-aspnet-backend-ios-notify-users
[Use Notification Hubs to send breaking news]: notification-hubs-ios-send-breaking-news
