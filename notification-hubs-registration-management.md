...
If you want to use [Templates](/documentation/articles/notification-hubs-templates), the device installation also hold all templates associated with that device in a JSON format (see sample above). The template names help target different templates for the same device.
